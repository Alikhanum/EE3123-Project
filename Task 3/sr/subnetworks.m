...
% info
% ******credit to: MATPOWER 7.1
% extract islands in the network

% Input:
% mpc: matpower case struct
%   (note: should maintain the initial data size (updated in each iteration
%   of the islands))
% varargin: can be ignored

% Output:
% mpck: cell of the subnetwork matpower case struct

% example:
% mpc_islands = subnetworks(mpc)

%%
function mpck = subnetworks(mpc, varargin)
